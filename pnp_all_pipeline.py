...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        default="configs/pnp/pnp-all-sunnyday2snowynight-v2.yaml",
        help="path to the feature extraction config file"
    )
    parser.add_argument(
        "--input_folder",
        type=str,
        default="/home/turing/cfs_cz/finn/codes/DrivingEdition/examples/text_to_image/data/jidu-data-III-sensors/jidu-III-sunnyday2snowynight-v2/",
        help="path to input folder",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default='models/ldm/stable-diffusion-v1/jidu_III_sunnyd2snowyn_v2_bs_6_lr_1e6_8000.ckpt',
        ...
        for block in blocks:
            ...
            if len(block) > 1 and "SpatialTransformer" in str(type(block[1])):
                feature_map_dict[f"{feature_type}_{block_idx}_self_attn_k_time_{i}"] = \
                    block[1].transformer_blocks[0].attn1.v
